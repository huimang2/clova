...
DOMAIN = "clova"
SIDEBAR_TITLE = "클로바홈EX"
ICON = "clova:clova"

CLOVA_API_ENDPOINT = f"/api/{DOMAIN}"
DATA_EXTRA_MODULE_URL = "frontend_extra_module_url"

PATH_BASE = "/clovafiles"
PATH_PANEL = f"{PATH_BASE}/clova-panel.js"
PATH_JS = f"{{}}/custom_components/{DOMAIN}/js"
PATH_JS_FILE = f"{PATH_BASE}/clova_tool.js"
